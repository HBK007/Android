 ...
 */
public class AdapterCustomReportDateListView extends ArrayAdapter<IncomeExpense> {

    private Activity context;
    private int layoutId;
    private ArrayList<IncomeExpense> arrayListItem = null;
    private SimpleDateFormat formatHour = new SimpleDateFormat("hh:mm a", Locale.getDefault());
    public AdapterCustomReportDateListView(Activity context, int resource, ArrayList<IncomeExpense> objects) {
...
//        get item in list type income
        ...
        txtContentItem.setText(tempItem.getContent());
        txtShowTime.setText(formatHour.format(tempItem.getHour()));
