 ...
 */
public class FragmentGraphViewMonth extends Fragment {
    private View view;
    ...
    private SimpleDateFormat formatTime = new SimpleDateFormat("MM-yyyy", Locale.getDefault());
...
//        default show income
    ...
    private void drawChartTypeItem(boolean flag, ArrayList<TypeIncomeExpense> tempArrayListItem){
        ...
        defaultRenderer.setMargins(new int[]{20, 20, 20, 5});
